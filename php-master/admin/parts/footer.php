        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Salt, Amman, Jordan</p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+771234567</p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>drivin@gmail.com</p>
                </div>
                <div class="col-lg-3 col-md-6">
                    <h4 class="text-light mb-4">Quick Links</h4>
                    <a class="btn btn-link" href="../courses.php">Our courses</a>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-square btn-outline-light me-1" href="https://www.twitter.com/"><i class="fab fa-twitter"></i></a>
