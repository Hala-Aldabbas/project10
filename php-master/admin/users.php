                    ...
                    if($err = mysqli_error($conn)){
                        ...
                        if(mysqli_num_rows($result) > 0){
                            while($rows = mysqli_fetch_assoc($result)){
                                ...
                                <td>{$rows['email']}</td>
                                <td>$role</td>
                                <td><a href='edit_user.php?uid={$rows['uid']}' class='btn btn-success mx-2 text-capitalize  mt-1'>edit</a><a href='delete_user.php?uid={$rows['uid']}' class='btn btn-danger text-capitalize  mt-1'>delete</a></td>
                            </tr>";
                            }
                        }else{
