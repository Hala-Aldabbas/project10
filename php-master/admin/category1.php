                    ...
                    if($err = mysqli_error($conn)){
                        ...
                        if(mysqli_num_rows($result) > 0){
                            while($rows = mysqli_fetch_assoc($result)){
                                ...
                                <td><a href='edit_category.php?cid={$rows['cid']}&cname={$rows['cname']}' class='btn btn-success mx-2 text-capitalize mt-1'>edit</a><a href='delete_category.php?cid={$rows['cid']}&puc={$rows['post_under_cat']}' class='btn btn-danger text-capitalize mt-1'>delete</a></td>
                            </tr>";
                            }
                        }else{
